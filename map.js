...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const layerInfo = {
    ...
    stormSurge:
      "The Storm Surge map identifies areas that could be inundated by storm-driven coastal flooding during hurricanes or tropical storms. With Zone 1 being at risk from Category 1 hurricanes, Zone 2 from Category 2 hurricanes, Zone 3 from Category 3 hurricanes, Zone 4 from Category 4 hurricanes, and Zone 5 from Category 5 hurricanes.",
